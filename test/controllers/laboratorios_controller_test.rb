...
class LaboratoriosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laboratorio" do
    assert_difference('Laboratorio.count') do
      post laboratorios_url, params: { laboratorio: { endereco: @laboratorio.endereco, nome: @laboratorio.nome, status: @laboratorio.status } }
    end
  ...
  test "should update laboratorio" do
    patch laboratorio_url(@laboratorio), params: { laboratorio: { endereco: @laboratorio.endereco, nome: @laboratorio.nome, status: @laboratorio.status } }
